...
public class Lista2_Ex3_While {
	...
	public static void main(String[] args) {
		 ...
		 * via teclado e mostre na tela o total de pessoas cuja idade seja menor que 21 anos e o total de 
		 * pessoas cuja idade seja maior que 50 anos. A leitura dos dados deve ser finalizada ao digitar 
		 * uma idade negativa.
		 * */
